            ...
            <div class="login-content flex-row-fluid d-flex flex-column justify-content-center position-relative overflow-hidden p-7 mx-auto">
                ...
                <div class="d-flex flex-column-fluid flex-center">
                    ...
                    <div class="login-form login-signin">
                        <!--begin::Form-->
                    {!! Form::open(['route' => 'cms.auth.password.update', 'class' => 'form']) !!}
                        {!! Form::hidden('token', $token) !!}
                        <!--begin::Title-->
                        <div class="pb-13 pt-lg-0 pt-5">
                            <h3 class="font-weight-bolder text-dark font-size-h4 font-size-h1-lg">Reset Password</h3>
                            <p class="text-muted font-weight-bold font-size-h4">Please enter a new password to access your account with.</p>
                        </div>
                        <!--end::Title-->
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::password('password_confirmation', ['class' => 'form-control form-control-solid h-auto py-6 px-6 rounded-lg', 'required' => true, 'autocomplete' => 'off']) !!}
                        </div>
                        <!--end::Form group-->
                        <!--begin::Form group-->
