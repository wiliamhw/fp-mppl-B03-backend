...
<script src="//cdn.tiny.cloud/1/{{ config('cms.tinymce_key') }}/tinymce/5/tinymce.min.js"></script>
<!--end::TinyMCE Scripts-->

<!--begin::Page Scripts(used by this page)-->
<script src="{{ asset('cms-assets/js/pages/widgets.js') }}"></script>
<script src="{{ asset('cms-assets/js/cms.js') }}"></script>
<!--end::Page Scripts-->

<!--begin::LiveWire Scripts-->
<livewire:scripts />
<!--end::LiveWire Scripts-->

<!--begin::Alpine.js Scripts-->
<script src="//cdn.jsdelivr.net/gh/alpinejs/alpine@v2.8.2/dist/alpine.min.js" defer></script>
<!--end::Alpine.js Scripts-->
