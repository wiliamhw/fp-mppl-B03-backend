    ...
    <link href="{{ asset('cms-assets/css/themes/layout/brand/light.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('cms-assets/css/themes/layout/aside/light.css') }}" rel="stylesheet" type="text/css" />
    <!--end::Layout Themes-->

    <!--begin::CMS Styles-->
    <link href="{{ asset('cms-assets/css/media-library-pro.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('cms-assets/css/cms.css') }}" rel="stylesheet" type="text/css" />
    <!--end::CMS Styles-->

    <!--begin::LiveWire Styles-->
    <livewire:styles />
    <!--end::LiveWire Styles-->
