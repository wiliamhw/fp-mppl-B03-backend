        ...
        <div class="container">
            ...
            <div class="card card-custom gutter-b example example-compact">
                <div class="card-header">
                    <h3 class="card-title">User Webinars</h3>
                    <div class="card-toolbar">
                        @if($this->currentAdmin->can('cms.user_webinar.create'))
                            <button wire:click="performAction('create')" type="button" class="btn mr-1 btn-primary">
                                <i class="fa fa-plus"></i> New User Webinar
                            </button>
                        @endif
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-12 col-md-12 text-md-right text-center">
                            ...
                            @if($this->currentAdmin->can('cms.user_webinar.delete'))
