...
class EditUserTest extends TestCase
{
    ...
    {
        Livewire::test('cms.users.edit-user', ['user' => $this->user])
            ->assertHasNoErrors();
    }

    /** @test */
    public function it_can_update_the_existing_user_record()
    {
        ...
        self::assertEquals('The user has been updated.', session('alertMessage'));
    }

    /** @test */
    public function it_can_cancel_updating_existing_user_and_go_back_to_index_page()
    {
        $data = $this->fakeRawData(User::class);
