...
use App\Http\Livewire\Cms\StaticPages\StaticPagesIndex;
...
class StaticPagesIndexTest extends TestCase
{
    use CmsTests;
    ...
    public function setUp(): void
    {
        ...
        StaticPage::factory(3)->create();
    }

    /** @test */
    public function datatable_component_is_accessible()
    {
        Livewire::test('cms.static-pages.static-pages-index')
            ->assertHasNoErrors();
    }
    ...
    public function it_can_load_its_state_from_the_session_store()
    {
        ...
        session()->put(StaticPagesIndex::class, $data);
