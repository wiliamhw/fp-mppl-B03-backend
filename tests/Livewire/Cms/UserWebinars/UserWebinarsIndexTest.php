...
use App\Http\Livewire\Cms\UserWebinars\UserWebinarsIndex;
...
class UserWebinarsIndexTest extends TestCase
{
    use CmsTests;
    ...
    public function setUp(): void
    {
        ...
        UserWebinar::factory(3)->create();
    }

    /** @test */
    public function datatable_component_is_accessible()
    {
        Livewire::test('cms.user-webinars.user-webinars-index')
            ->assertHasNoErrors();
    }
    ...
    public function it_can_load_its_state_from_the_session_store()
    {
        ...
        session()->put(UserWebinarsIndex::class, $data);
