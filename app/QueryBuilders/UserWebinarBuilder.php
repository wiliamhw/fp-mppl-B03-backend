...
final class UserWebinarBuilder extends Builder
{
    ...
    protected function getAllowedFilters(): array
    {
        return [
            ...
            'feedback',
            'payment_token',
            AllowedFilter::exact('user_webinar.id'),
            AllowedFilter::exact('user_webinar.user_id'),
            AllowedFilter::exact('user_webinar.webinar_id'),
            'user_webinar.payment_status',
            'user_webinar.payment_method',
            'user_webinar.feedback',
            'user_webinar.payment_token',
            ...
            AllowedFilter::exact('webinar.id'),
            ...
            AllowedFilter::exact('webinar.published_at'),
            AllowedFilter::exact('webinar.created_at'),
            AllowedFilter::exact('webinar.updated_at'),
        ];
    }
